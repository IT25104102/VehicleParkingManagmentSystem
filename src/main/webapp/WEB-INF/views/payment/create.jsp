...
<head>
    ...
    <title>ParkCity | Booking Summary</title>
    ...
    <style>
        ...
        .summary-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-size: 0.9rem; }
        .summary-row:last-child { border-bottom: none; }
        .summary-row .label { color: var(--text-dim); }
        .summary-row .value { font-weight: 600; color: var(--text-main); }
        .total-display { background: rgba(55,255,139,0.06); border: 1px solid rgba(55,255,139,0.2); border-radius: 10px; padding: 16px; text-align: center; margin-bottom: 20px; }
        .total-display .t-label { font-size: 0.75rem; color: var(--text-dim); margin-bottom: 4px; }
        .total-display .t-amount { font-size: 2rem; font-weight: 800; color: var(--btn-neon); }
        .phone-group { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 24px; margin-bottom: 20px; }
        .phone-group label { display: block; font-size: 0.75rem; font-weight: 600; color: var(--cyan); text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; }
        .phone-group input { width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(26,217,240,0.25); border-radius: 8px; padding: 12px 14px; color: var(--text-main); font-family: 'Montserrat', sans-serif; font-size: 0.9rem; outline: none; transition: 0.3s; }
        .phone-group input:focus { border-color: var(--cyan); box-shadow: 0 0 12px rgba(26,217,240,0.2); }
        .phone-group input::placeholder { color: rgba(255,255,255,0.2); }
        .phone-hint { font-size: 0.72rem; color: var(--text-dim); margin-top: 6px; }
        .btn-primary { width: 100%; background: var(--btn-neon); border: none; border-radius: 20px; padding: 14px; font-family: 'Montserrat', sans-serif; font-size: 0.9rem; font-weight: 800; color: #0c1a12; cursor: pointer; transition: 0.3s; }
...
<header class="main-header">
    <div class="top-bar">
        <div class="logo">
            ...
            <span style="color:white;">Park</span><span style="color:#37ff8b;">City</span>
        </div>
...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/payment/create">
        ...
        <div class="phone-group">
            ...
            <p class="phone-hint">Enter the number you want to be contacted on</p>
        </div>
    ...
    <a href="${pageContext.request.contextPath}/slots"
